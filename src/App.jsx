...
function App() {
  ...
  const [filters, setFilters] = useState({
    cardType: 'all', // all, monster, spell, trap
    monsterType: 'all', // all, normal, effect, fusion, synchro, xyz, link, ritual, pendulum
    spellType: 'all', // all, normal, continuous, quick-play, equip, field, ritual
    trapType: 'all', // all, normal, continuous, counter
    level: 'all' // all, 1-13
  })
